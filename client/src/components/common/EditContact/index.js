        ...
        >
            ...
            <div className={styles.doubleInputField}>
                <div className={styles.aloneInputField}>
                    ...
                    <input
                        className={errors.level && touched.level && errors.level?styles.error:''}
                        type="text"
                        name="level"
                        onChange={handleChange}
                        onBlur={handleBlur}
                ...
                <div className={styles.aloneInputField}>
                    ...
                    <input
                        className={errors.relationship && touched.relationship && errors.relationship?styles.error:''}
                        type="text"
                        name="relationship"
                        onChange={handleChange}
                        onBlur={handleBlur}
            ...
            <div className={styles.bottomBtns}>
                <Button text="Cancel" isCancel={true} handleClick = {()=>dispatch(editContact(null))}/>
